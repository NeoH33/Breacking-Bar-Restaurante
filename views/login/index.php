...
<!-- <body style="font-family: Comic Sans;" >
    ...
    <br>
    <br>
    <img src="fondoLogin.jpg" alt=""> -->
    <div class="container">
        <div class="row justify-content-center pt-5 mt-5 m-1">
            <div class="col-md-6 col-sm-8 col-xl-4 col-lg-5 formulario">
                <form method="post" action="<?php echo constant('URL') ?>login/validar">
                    ...
                    <div class="form-group mx-sm-4 pb-2">
                        <input type="submit" name="logi" class="btn btn-block ingresar" value="INGRESAR">
                    </div>
                    <div class="form-group mx-sm-4 text-center">
                        <span class="">No tienes una cuenta</a></span>
                    </div>
                    <div class="form-group text-center">
                        <span><a href="<?php echo constant('URL') ?>registroUsuario" class="olvide1">REGISTRARSE</a></span>
                    </div>
        </form>
